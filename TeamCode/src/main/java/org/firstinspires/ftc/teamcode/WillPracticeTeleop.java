...
@TeleOp(name="WillPracticeTeleop", group="")
public class WillPracticeTeleop extends LinearOpMode {
    public WillPracticeTeleop() throws InterruptedException {}
    ...
    public void runOpMode() throws InterruptedException {
        ...
        WillPracticeOuttake outtake = new WillPracticeOuttake(hardwareMap, telemetry);

        //=====Set up variables=====
        double joyx, joyy, joyz, gas, brake, baseSpeed;
        boolean centricityToggle, resetDriveAngle, lowerLift, raiseLift;
        ...
        while(opModeIsActive()){
            ...
            lowerLift = currentGamepad1.x && !previousGamepad1.x;
            raiseLift = currentGamepad1.b && !previousGamepad1.b;
